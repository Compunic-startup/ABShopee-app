        ...
        <TouchableOpacity activeOpacity={0.9}>
          ...
          <View style={styles.itemSection}>
            <View style={styles.itemBox}>
              <View style={styles.itemIconContainer}>
                <Icon
                  name={
                    firstItem?.itemSnapshot?.itemType === 'digital'
                      ? 'download'
                      : 'cube-outline'
                  }
                  size={24}
              ...
              <View style={styles.itemDetails}>
                ...
                {!!firstItem?.selectedAttributes?.attributes?.length && (
                  <View style={styles.attributesContainer}>
                    {firstItem.selectedAttributes.attributes.map(
                      (attr, idx) => (
          ...
          <View style={styles.bottomSection}>
            ...
            <View style={styles.paymentContainer}>
              <Icon
                name={getPaymentIcon(payment?.provider)}
                size={18}
                color="#666"
              />
              <View style={styles.paymentDetails}>
                ...
                <Text
                  style={[
                    ...
                    {
                      color:
                        payment?.status === 'success' ? '#4CAF50' : '#FF9800',
                    },
                  ]}
                >
